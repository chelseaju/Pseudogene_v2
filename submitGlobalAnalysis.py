...
def main(parser):
	...
	if not os.path.exists(outputPath):
        ...
        script = "bash global_analysis_v1.sh %s %s" %(dir, "101")
        ...
        subprocess.call('qsub -cwd -m ea -l highp,h_rt=24:00:00,h_data=6G ' + scriptfile, shell=True)
        print "qsub -cwd -m ea -l highp,h_rt=24:00:00,h_data=6G %s" %(scriptfile)


if __name__ == "__main__":
        parser = argparse.ArgumentParser(prog='submitGlobalAnalysis.py')
